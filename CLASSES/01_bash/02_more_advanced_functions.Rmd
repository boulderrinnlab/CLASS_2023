...
awk 'BEGIN {FS="\t"}; {print $6}' data/encode_awk_lessons.tsv > DBP.txt
cat DBP.txt
...
awk 'BEGIN {FS="\t"}; {print $6}' data/encode_awk_lessons.tsv | sort | wc -l
...
awk -F $'\t' '{if ($6 == "POL2") print $0;}' data/encode_awk_lessons.tsv | wc -l 
