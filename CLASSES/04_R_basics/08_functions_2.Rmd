...
library(tidyverse)
library(IRanges)
source("../../util/BCHM5631_functions.R")


# setting file paths
basepath <- "/scratch/Shares/rinnclass/CLASS_2023/chipseqprofs"
peak_path <- "CLASS_2023/CLASSES/03_Nextflow/00_my_chipseq/results/bwa/mergedLibrary/macs/broadPeak_good_files/"
...
?matrix
  ...
  # dbp_consensus <- all_peaks[rowSums(peak_exists) > 5]
