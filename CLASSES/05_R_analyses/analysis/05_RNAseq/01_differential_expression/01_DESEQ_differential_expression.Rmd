...
save(counts, counts_filtered, rlog_counts, g2s, gencode_genes, rlog_counts, rlog_counts_matrix, samplesheet, file = "results/DESEQ_RLOG.RData")
     
# erase environment and reload!
load("results/DESEQ_RLOG.RData", verbose = T)

# seriously that never get's old and saves so much time !
# one potential downside is propagation of errors -- if one
# file has an error than it could propogate throughout other analyses.
