...
```{git}
git change-commits GIT_AUTHOR_EMAIL "valle20t@gmail.com" "teva8543@colorado.edu" HEAD~10..HEAD

git change-commits GIT_AUTHOR_EMAIL "githubemail" "oldemail" HEAD~10..HEAD
