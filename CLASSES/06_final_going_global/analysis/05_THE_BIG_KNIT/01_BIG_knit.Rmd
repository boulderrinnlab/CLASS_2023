...
```{r promoter peak occurrence matrix}
...
# First making metaplots for promoters that are high binder versus lowbinders
...
load("filtered_consensus_list.RData")
...
write_rds(combined_super_binder_metaplot_profile, "results/superbinder_metaplot_df.rds")
