...
consensusPeakPath <- "/scratch/Shares/rinnclass/CLASS_2023/JR/CLASS_2023/CLASSES/06_final_going_global/analysis/01_create_consensus_peaks/results/filtered_consensus_peaks"
...
fl <- list.files(consensusPeakPath, full.names = T)

peak_list <- lapply(fl, rtracklayer::import)

names(peak_list) <- gsub("/scratch/Shares/rinnclass/CLASS_2023/JR/CLASS_2023/CLASSES/06_final_going_global/analysis/01_create_consensus_peaks/results/filtered_consensus_peaks|_filtered_consensus_peaks", "", fl)



peak_list <- import_peaks(consensus_file_path = file.path(consensusPeakPath))
