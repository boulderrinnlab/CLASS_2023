...
save(filtered_consensus_list, gencode_genes, lncrna_gene_ids, mrna_gene_ids, num_peaks_df, peak_occurence_df, promoter_peak_matrix, lncrna_mrna_promoters, mrna_lncrna_genes, file = "results/peak_features.RData")
